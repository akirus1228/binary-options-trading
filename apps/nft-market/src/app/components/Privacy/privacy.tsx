...
export const PrivacyPage = (props: PrivacyProps): JSX.Element => {
  return (
    <Box sx={{ width: "100%", padding: "0 20px", mt: { xs: "50px", md: "100px" } }}>
      ...
      <h3>
        Thank you for choosing to be part of our community at LiqdNFT ("organization,",
        "org", "we," "us," or "our"). We are committed to protecting your personal
        information and your right to privacy. If you have any questions or concerns about
        this privacy notice or our practices with regard to your personal information,
        please contact us at info@liqdnft.com. This privacy notice describes how we might
        use your information if you: Visit our website at https://www.liqdnft.com/
      </h3>
      <h3>
      ...
      <h3>
        ...
        agree with, please discontinue use of our Services immediately. Please read this
        privacy notice carefully, as it will help you understand what we do with the
        information that we collect.
      </h3>
      <Box>
        <h2>1. WHAT INFORMATION DO WE COLLECT?</h2>
        <h3> Information you disclose to us</h3>
        <h3>In Short: We collect information that you provide to us.</h3>
        <h3>
          We collect information that you voluntarily provide to us when you express an
        ...
        <h3>
          The information that we collect depends on the context of your interactions with
          us and the Website, the choices you make, and the products and features you use.
        ...
        <h3>
          ...
          addresses; mailing addresses; contact preferences; and other similar
          information.
        </h3>
        <h3>
        ...
        <h3>
          ...
          Website. This information does not reveal your specific identity (like your name
          or contact information) but may include device and usage information, such as
        ...
        <h3>We also collect information through cookies and similar technologies.</h3>
        <h3>The information we collect includes:</h3>
        <h3>
          Log and Usage Data. Log and usage data are service-related, diagnostic, usage,
          and performance information our servers automatically collect when you access or
          use our Website and which we record in log files. Depending on how you interact
          with us, this log data may include your IP address, device information, browser
          type, and settings, and information about your activity on the Website (such as
        ...
        <h3>
          ...
          Note, however, that if you choose to opt out, you may not be able to use certain
      ...
      <Box>
        ...
        <h3>
          We process your information for purposes based on legitimate interests, the
          fulfillment of our contract with you, compliance with our legal obligations,
          and/or your consent.
        </h3>
        <h3>
          We use personal information collected via our Website for a variety of purposes
          described below. We process your information for these purposes in reliance on
          our legitimate business interests, in order to enter into or perform a contract
        ...
        <h3>
          To send administrative information to you. We may use your personal information
          to send you the product, service, and new feature information and/or information
        ...
        <h3>
          ...
          keep our Website safe and secure (for example, for fraud monitoring and
          prevention).
        </h3>
        <h3>
          To enforce our terms, conditions, and policies for business purposes, to comply
          with legal and regulatory requirements, or in connection with our contract. To
          respond to legal requests and prevent harm.
        </h3>
        <h3>
          If we receive a subpoena or other legal request, we may need to inspect the data
          we hold to determine how to respond. Fulfill and manage your orders.
        </h3>
        <h3>
        ...
        <h3>
          To deliver and facilitate the delivery of services to the user. We may use your
          information to provide you with the requested service.
        </h3>

        <h3>
          To respond to user inquiries/offer support to users. We may use your information
        ...
        <h3>
          ...
          marketing partners may use the personal information you send to us for our
          marketing purposes if this is in accordance with your marketing preferences. For
          example, when expressing an interest in obtaining information about us or our
          Website, subscribing to marketing, or otherwise contacting us, we will collect
          personal information from you. You can opt out of our marketing emails at any
        ...
        <h3>
          ...
          display personalized content and advertising (and work with third parties who do
          so) tailored to your interests and/or location and to measure its effectiveness.
        </h3>

        <h3>Responding to Job Applications.</h3>
      </Box>
      <Box>
        <h2>3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</h2>
        <h3>
          In Short: We only share information with your consent, to comply with laws, to
          provide you with services, to protect your rights, or to fulfill organization
          obligations.
        </h3>
        <h3>
        ...
        <h3>
          ...
          a judicial proceeding, court order, or legal processes, such as in response to a
        ...
        <h3>
          ...
          which we are involved. More specifically, we may need to process your data or
        ...
        <h3>
          ...
          delivery, hosting services, customer service, and marketing efforts. We may
          allow selected third parties to use tracking technology on the Website, which
          will enable them to collect data on our behalf about how you interact with our
          Website over time.{" "}
        </h3>
        <h3>
          ...
          understand online activity. Unless described in this notice, we do not share,
        ...
        <h3>
          ...
          will require those affiliates to honor this privacy notice. Affiliates include
      ...
      <Box>
        ...
        <h3>
          ...
          third parties. If we have processed your data based on your consent and you wish
          to revoke your consent, please contact us using the contact details provided in
          the section below titled "HOW CAN YOU CONTACT US ABOUT THIS NOTICE?".
        </h3>
        <h3>Data Analytics Services</h3>
        <h3>Data Storage Service Providers</h3>
        <h3>Cloud Computing Services</h3>
        <h3>Communication & Collaboration Tools</h3>
        <h3>Performance Monitoring Tools</h3>
        <h3>Product Engineering & Design Tools</h3>
        <h3>Social Networks</h3>
        <h3>Sales & Marketing Tools</h3>
        <h3>Testing Tools</h3>
        <h3>Website Hosting Service Providers</h3>
      </Box>
      <Box>
      ...
      <Box>
        ...
        <h3>
          ...
          a request, please use the contact details provided below. We will consider and
        ...
        <h3>
          ...
          this could affect certain features or services of our Website. To opt out of
      ...
      <Box>
        ...
        <h3>
          ...
          personal information, please reach out to us at info@liqdnft.com
        </h3>
      </Box>
    </Box>
  );
