...
const DemoAccount = () => {
  return (
    <div className="trading-experience bg-woodsmoke sm:pl-40 mt-90 rounded-2xl relative flex xs:flex-col lg:flex:row xs:items-center sm:items-start xs:justify-start lg:items-start lg:justify-start">
